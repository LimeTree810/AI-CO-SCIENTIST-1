...
def main():
    ...
    # 1.constrained_LHS_100k.csv 파일 읽기
    current_dir = os.path.dirname(os.path.abspath(__file__))
    input_file = os.path.join(current_dir, "1.constrained_LHS_100k.csv")
    ...
    # 엑셀 파일로 저장
    out_path = os.path.join(current_dir, "constrained_LHS_100K.xlsx")
